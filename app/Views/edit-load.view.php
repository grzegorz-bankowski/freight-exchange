...
<div class="kontener">
    ...
    <div class="content" style="max-width: 100%;">
        ...
        <main class="general">
            <h1 class="settings">Edit load offer</h1>
            <section class="main-content">
                <form action="./offers?id=<?php echo $load['id']; ?>&action=update-load" method="post" class="form">
                    <h2>Origin details</h2>
                        <div class="form-group">
                            <label class="right-inline" for="places">Name of place <span style="color:red">*</span></label>
                            <input class="input-control" type="text" name="places" id="places" value="<?php echo htmlspecialchars($load['places']); ?>" required />
                            ...
                            <select class="input-control" id="countrys" name="countrys" required>
                                ...
                                foreach($countries as $countrys) {
                                    if ($countrys == htmlspecialchars($load['countrys'])) {
                            ...
                            <input class="input-control" type="text" name="citys" id="citys" value="<?php echo htmlspecialchars($load['citys']); ?>" required />
                            <label class="right-inline" for="codes">Postal code <span style="color:red">*</span></label>
                            <input class="input-control" type="text" name="codes" id="codes" value="<?php echo htmlspecialchars($load['codes']); ?>" required>
                        </div>
                        <div class="form-group">
                            <label class="right-inline" for="streets">Street</label>
                            <input class="input-control" type="text" name="streets" id="streets" value="<?php echo htmlspecialchars($load['streets']); ?>">
                            <label class="right-inline" for="dates">Date of loading <span style="color:red">*</span></label>
                            <input class="input-control" type="date" name="dates" id="dates" value="<?php echo htmlspecialchars($load['dates']); ?>" required>
                            <label class="right-inline" for="times">Time of loading <span style="color:red">*</span></label>
                            <input class="input-control" type="time" name="times" id="times" value="<?php echo htmlspecialchars($load['times']); ?>" required>
                        </div>
                    <h2>Destination details</h2>
                    <div class="form-group">
                            <label class="right-inline" for="placed">Name of place <span style="color:red">*</span></label>
                            <input class="input-control" type="text" name="placed" id="placed" value="<?php echo htmlspecialchars($load['placed']); ?>" required/>
                            ...
                            <input class="input-control" type="text" name="cityd" id="cityd" value="<?php if (isset($load['cityd'])) { echo htmlspecialchars($load['cityd']); } ?>" required/>
                            <label class="right-inline" for="coded">Postal code <span style="color:red">*</span></label>
                            <input class="input-control" type="text" name="coded" id="coded" value="<?php if (isset($load['coded'])) { echo htmlspecialchars($load['coded']); } ?>" required />
                    </div>
                    <div class="form-group">
                            <label class="right-inline" for="streetd">Street</label>
                            <input class="input-control" type="text" name="streetd" id="streetd" value="<?php if (isset($load['streetd'])) { echo htmlspecialchars($load['streetd']); } ?>">
                            <label class="right-inline" for="dated">Date of arrival <span style="color:red">*</span></label>
                            <input class="input-control" type="date" name="dated" id="dated" value="<?php if (isset($load['dated'])) { echo htmlspecialchars($load['dated']); } ?>" required />
                            <label class="right-inline" for="timed">Time of arrival <span style="color:red">*</span></label>
                            <input class="input-control" type="time" name="timed" id="timed" value="<?php if (isset($load['timed'])) { echo htmlspecialchars($load['timed']); } ?>" required />
                    </div>
                    <h2>Load details</h2>
                    <div class="form-group">
                            <label class="right-inline" for="weight">Weight <span style="color:red">*</span></label>
                            <input class="input-control" type="number" name="weight" id="weight" step="1" min="0" max="50000" value="<?php if (isset($load['weight'])) { echo htmlspecialchars($load['weight']); } ?>" required />
                            <label class="right-inline" for="type_of_good">Type of goods</label>
                            <input class="input-control" type="text" name="type_of_good" id="type_of_good" value="<?php if (isset($load['type_of_good'])) { echo htmlspecialchars($load['type_of_good']); } ?>" />
                            <label class="right-inline" for="number_of_package">Number of packages</label>
                            <input class="input-control" type="number" name="number_of_package" id="number_of_package" step="1" min="0" max="1000000" value="<?php if (isset($load['number_of_package'])) { echo htmlspecialchars($load['number_of_package']); } ?>" />
                            ...
                            <select class="input-control" id="type_of_package" name="type_of_package">
                                ...
                                foreach($packages as $package) {
                                    if ($package == $load['type_of_package']) {
                            ...
                            <input class="input-control" type="number" name="payrate" id="payrate" step="0.1" min="1" max="1000000" value="<?php if (isset($load['payrate'])) { echo htmlspecialchars($load['payrate']); } ?>" required />
                    </div>
                    <div class="form-group">
                            ...
                            <input class="input-control" id="distance" type="number" step="1" min="0" max="1000000" name="distance" value="<?php if (isset($load['distance'])) { echo htmlspecialchars($load['distance']); } ?>" required />
                            <label class="right-inline" for="rpk">Rate per km <span style="color:red">*</span></label>
                            <input class="input-control" id="rpk" step="0.1" type="number" min="0" max="1000000" name="rate_per_km" value="<?php if (isset($load['rate_per_km'])) { echo htmlspecialchars($load['rate_per_km']); } ?>" required />
                            ...
                            <select class="input-control" id="trailer" name="trailer" required>
                                ...
                                foreach ($trailers as $trailer) {
                                    if ($trailer == htmlspecialchars($load['trailer'])) {
                    ...
                    <div class="form-group">
                        ...
                        <input class="input-control" name="description" id="description" value="<?php if (isset($load['description'])) { echo htmlspecialchars($load['description']); } ?>">
                    </div>
                    <div class="form-group">
