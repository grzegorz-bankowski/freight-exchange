...
<div class="kontener">
    ...
    <div class="content">
        ...
        <main class="general">
            <h1 class="settings">Add vehicle offer</h1>
                ...
                <form action="./add-vehicle" method="post" class="form">
                    <h2>Origin details</h2>
                        <div class="form-group">
                            ...
                            <input class="input-control" type="text" name="places" id="places" value="<?php if (isset($_GET['places'])) { echo $_GET['places']; } ?>" autofocus required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="input-control" type="text" name="streets" id="streets" "<?php if (isset($_POST['streets'])) { echo htmlspecialchars($_POST['streets']); } ?>">
                    ...
                    <h2>Destination details</h2>
                        <div class="form-group">
                            ...
                            <input class="input-control" name="placed" id="placed" value="<?php if (isset($_GET['placed'])) { echo $_GET['placed']; } ?>" />
                            ...
                            <input class="input-control" type="text" name="cityd" id="cityd" value="<?php if (isset($_POST['times'])) { echo htmlspecialchars($_POST['times']); } ?>">
                            <label class="right-inline" for="coded">Postal code</label>
                            <input class="input-control" type="text" name="coded" id="coded" value="<?php if (isset($_POST['coded'])) { echo htmlspecialchars($_POST['coded']); } ?>">
                        </div>
                        <div class="form-group">
                            <label class="right-inline" for="streetd">Street</label>
                            <input class="input-control" type="text" name="streetd" id="streetd" value="<?php if (isset($_POST['streed'])) { echo htmlspecialchars($_POST['streed']); } ?>">
                            <label class="right-inline" for="dated">Date of arrival</label>
                            <input class="input-control" type="date" name="dated" id="dated" value="<?php if (isset($_POST['dated'])) { echo htmlspecialchars($_POST['dated']); } ?>">
                            <label class="right-inline" for="timed">Time of arrival</label>
                            <input class="input-control" type="time" name="timed" id="timed" value="<?php if (isset($_POST['times'])) { echo htmlspecialchars($_POST['times']); } ?>">
                        </div>
                    <h2>Load details</h2>
                        <div class="form-group">
                            <label class="right-inline" for="weight">Max weight <span style="color:red">*</span></label>
                            <input class="input-control" id="weight" type="number" name="weight" step="1" min="0" max="50000" value="<?php if (isset($_POST['weight'])) { echo htmlspecialchars($_POST['weight']); } ?>" required>
                            <label class="right-inline" for="type_of_good">Type of goods</label>
                            <input class="input-control" type="text" id="type_of_good" name="type_of_good" value="<?php if (isset($_POST['type_of_good'])) { echo htmlspecialchars($_POST['type_of_good']); } ?>" />
                            <label class="right-inline" for="number_of_package">Number of packages</label>
                            <input class="input-control" type="number" name="number_of_package" id="number_of_package" step="1" min="0" max="1000000" value="<?php if (isset($_POST['number_of_package'])) { echo htmlspecialchars($_POST['number_of_package']); } ?>" />
                            ...
                            <input class="input-control" step="0.1" min="1" max="1000000" type="number" name="payrate" id="payrate" value="<?php if (isset($_POST['payrate'])) { echo htmlspecialchars($_POST['payrate']); } ?>" />
                        </div>
                        <div class="form-group">
                            ...
                            <input class="input-control" type="number" step="1" min="0" max="1000000" name="distance" id="distance" value="<?php if (isset($_POST['distance'])) { echo htmlspecialchars($_POST['distance']); } ?>" />
                            <label class="right-inline" for="rate_per_km">Rate per km <span style="color:red">*</span></label>
                            <input class="input-control" step="0.1" type="number" min="0" max="1000000" name="rate_per_km" id="rate_per_km" value="<?php if (isset($_POST['rate_per_km'])) { echo htmlspecialchars($_POST['rate_per_km']); } ?>" required/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="input-control" id="description" value="<?php if (isset($_POST['times'])) { echo htmlspecialchars($_POST['times']); } ?>">
                    </div>
                    <div class="form-group">
