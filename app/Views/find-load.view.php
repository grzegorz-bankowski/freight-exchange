...
<div class="kontener">
    ...
    <div class="content">
        ...
        <main class="general">
            <h1 class="settings">Find load</h1>
            <section class="main-content">
                <form action="./find-load" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <select class="input-control" id="trailer" name="trailer">
                            <?php
            ...
            <h1 class="settings">All load offers</h1>
            <?php
            ...
            if ($loads !== 0) {
                ...
                foreach ($loads as $load) {
                    ...
                    echo "<td class=\"weight\">" . $load['weight'] . "</td>";
                    echo "<td class=\"distance\">" . $load['distance'] . "</td>";
                    echo "<td>" . $load['payrate'] . ' ' . $load['currency'] . "</td>";
                    echo "<td class=\"rpk\">" . $load['rate_per_km'] . ' ' . $load['currency'] . "</td>";
                    echo "<td><a href=./load?id=" . $load['id'] . "&action=more><span class=show>More</span></a><a href=./load?id=" . $load['id'] . "&action=reserve><span class=edit>Reserve</span></a></td>";
                    echo "</tr>";
                }
                echo "<tr style=\"border:0; background-color: white\">";
                echo "<td id=\"myCell\" class=\"paginator\" style=\"border:0;background-color: white;\"\">";
                if ($numpages > 1) {
                ...
                echo "<h4 style=\"color:red; margin:50px 0 50px 50px;\">We not have any load offers now</h4>";
            }
            ?>
        </main>
    </div>
